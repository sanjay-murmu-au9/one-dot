    ...
    <main>
      ...
      <section className="relative pt-32 pb-20 px-6 text-center overflow-hidden">
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <div className="reveal reveal-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/about" className="btn-ghost text-[16px] px-8 py-4 font-medium">
              About the Concept
            </Link>
          </div>
        </div>
      ...
      <section id="gallery" className="py-24 overflow-hidden">
        ...
        <div className="hidden md:block space-y-4 marquee-mask">
          <DraggableAutoScroll direction="left" speed={0.4}>
          ...
          <DraggableAutoScroll direction="right" speed={0.4}>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="reveal text-center mb-16">
            ...
            >
              Your life, visualized. In three simple steps.
            </h2>
          </div>
            ...
            {[
              {
                ...
                body: 'Select from life-in-weeks grids, hourglasses, or progress visualizations — each designed to make time tangible.',
              },
              {
                num: '02',
                icon: '✦',
                title: 'Make it yours',
                body: 'Enter your birth year to see your life mapped out. Customize colors and add personal milestones that matter to you.',
              },
              {
                num: '03',
                icon: '📱',
                title: 'Live with intention',
                body: 'Set as your lock screen. Every glance becomes a reminder: time is finite, make it count.',
              },
            ].map((step, i) => (
              <div
                key={i}
