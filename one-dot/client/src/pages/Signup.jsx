...
export default function Signup() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl font-medium text-center mb-8 tracking-tight">Create account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            disabled={loading}
            className="w-full bg-black text-white py-3.5 rounded-xl font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 mt-2"
            type="submit"
          >
            Sign Up
          </button>
